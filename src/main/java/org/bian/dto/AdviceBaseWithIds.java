 ...
 * AdviceBaseWithIds
 */
public class AdviceBaseWithIds   {
  private String complianceAuditGuidelineAssessmentReference = null;

  private String complianceAuditAdvisoryTaskReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier 
   * @return complianceAuditAdvisoryTaskReference
  **/

  public String getComplianceAuditAdvisoryTaskReference() {
    return complianceAuditAdvisoryTaskReference;
  }

  public void setComplianceAuditAdvisoryTaskReference(String complianceAuditAdvisoryTaskReference) {
    this.complianceAuditAdvisoryTaskReference = complianceAuditAdvisoryTaskReference;
  }
